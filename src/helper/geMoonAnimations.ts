...
export const getMoonAnimation = (side: string) => {
    ...
    switch (side) {
        case 'top':
            animations = {
                initial: { position: 'fixed', top: -300, right: 0, left: 0, margin: 'auto', },
                animate: { top: -175 },
        ...
        case 'bottom':
            animations = {
                initial: { position: 'fixed', bottom: -300, right: 0, left: 0, margin: 'auto', },
                animate: { bottom: -175 },
        ...
        case 'right':
            animations = {
                initial: { position: 'fixed', right: -300, top: 0, bottom: 0, margin: 'auto', },
                animate: { right: -175 },
        ...
        case 'left':
            animations = {
                initial: { position: 'fixed', left: -300, top: 0, bottom: 0, margin: 'auto', },
                animate: { left: -175 },
